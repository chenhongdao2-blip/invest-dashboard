...
| HERO8 | 轴/tooltip：x category boundaryGap:false + axisLine #1a1a1a w1 + label mono 10 #8a8580 interval 20 无 splitLine；y value scale 无轴线 + splitLine #ebd9c8；tooltip axis + 虚线十字 #b8b1a8 + 墨底 #1a1a1a 奶字 mono 11 p8-12 + 行含 `(+x.x%)` 折算收益 | EO |
