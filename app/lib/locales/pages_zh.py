...
STRINGS = {
    ...
    "hc_etf.coverage": "{n} 支有权重成分 = 基金的 {cov}%",
    "hc_etf.rest_more": "另有 {n} 支成分股:{syms}",
    "hc_etf.rest_more_trunc": "另有 {n} 支成分股 —— 前 {shown} 支:{syms} …",
    ...
    "picks.tbl.col_rank": "名次",
    "picks.tbl.col_tick": "代码",
    "picks.tbl.col_name": "名称",
    "picks.tbl.col_score": "评分",
    "picks.tbl.col_weight": "权重",
    "picks.tbl.col_price": "现价",
    "picks.tbl.col_d1": "1日",
    "picks.tbl.col_d5": "5日",
    "picks.tbl.col_m1": "1月",
    "picks.tbl.col_ytd": "年初至今",
    "picks.tbl.col_since": "建仓来",
    "picks.tbl.col_spark": "20日走势",
    "picks.tbl.nm_label": "NM",
    "picks.tbl.brand": "CMSI",
    "picks.tbl.footnote": "含息复权总回报（yfinance auto_adjust=True）· 建仓来=入选日至今 · 年初至今=当年首个交易日至今 · 走势=近 20 个交易日收盘",
    # HD scorecard (治理/财务/护城河)
    "picks.sc.hd.col_num": "#",
    "picks.sc.hd.col_held": "建",
    "picks.sc.hd.col_tick": "代码",
    "picks.sc.hd.col_name": "名称",
    "picks.sc.hd.col_ta": "行业",
    "picks.sc.hd.col_final": "总分",
    "picks.sc.hd.col_seg": "段收益",
    "picks.sc.hd.col_driver": "评级 / 状态",
    "picks.sc.hd.nm_label": "—",
    "picks.sc.hd.sum_top20": "Top20 等权",
    "picks.sc.hd.sum_pool": "全池等权",
    "picks.sc.hd.sum_unheld": "仅未建仓",
    "picks.sc.hd.sum_diff": "Top20 − 全池",
    "picks.sc.hd.sum_diff_note": "选中效果",
    "picks.sc.hd.sum_n_suffix": "支",
    "picks.sc.hd.brand": "CMSI",
    "picks.sc.hd.footnote": "总分 = 治理55 + 财务25 + 护城河20（愿意分 / 分得出 / 分得久）· ● = 进入建仓组合（前 20）· 评分为建仓时点快照（v1 2026-03-19 / v2 2026-06-10 评分底稿）· 段区间 v1=03-20→06-11 / v2=06-11→07-07 · 段收益 = yfinance 含息复权（归因正式口径 Wind TR，等权对账一致）· † = 未建仓票为事后对照 · 选中效果条为等权口径（v2 实盘为评分定权 + 12% 现金）",
    "picks.sc.hd.sub_gov": "治理55",
    "picks.sc.hd.sub_fin": "财务25",
    "picks.sc.hd.sub_moat": "护城河20",
    # Biotech scorecard (L6 归因附表)
    "picks.sc.bio.col_num": "#",
    "picks.sc.bio.col_held": "建",
    "picks.sc.bio.col_tick": "代码",
    "picks.sc.bio.col_name": "公司",
    "picks.sc.bio.col_ta": "TA",
    "picks.sc.bio.col_final": "Final",
    "picks.sc.bio.col_seg": "段收益",
    "picks.sc.bio.col_driver": "股价驱动 / 状态",
    "picks.sc.bio.nm_label": "—",
    "picks.sc.bio.sum_top20": "Top20 等权",
    "picks.sc.bio.sum_pool": "全池等权",
    "picks.sc.bio.sum_unheld": "仅未建仓",
    "picks.sc.bio.sum_diff": "Top20 − 全池",
    "picks.sc.bio.sum_diff_note": "选中效果",
