...
|------|-------|-------|-------|-------|-------|
| 收入（USD mn） | 16,745 | 20,075 | 21,908 | 23,542 | 25,298 |
| 收入增速 | +18% | +20% | +9% | +7% | +7% |
| 毛利率 | — | — | 69.2% | 69.2% | 69.2% |
| Adj 净利润（USD mn） | 3,709 | 4,578 | 5,069 | 5,572 | 6,128 |
| 净利润增速 | +22% | +23% | +11% | +10% | +10% |
...
- Adj EPS：USD 3.34-3.41

**TP 拆解**：

| 情景 | Target P/E（2027E） | TP（USD） | Upside |
|------|----------------|---------|--------|
| Bull | 25.0x | 93 | +43.6% |
| Base | 21.0x | 78 | +20.6% |
| Bear | 17.0x | 63 | -2.3% |
...
### 1. Cardiovascular（核心收入主体）

| 子业务 | 2026E（USD mn）| 备注 |
|--------|-------------|------|
| Electrophysiology (EP) | 3,750 | FaraPulse PFA 全球领导者；1Q26 内生 +21.7% |
| LAAC (Watchman) | 2,255 | LAAC 全球黄金标准；1Q26 内生 +18.8% |
| IC & VT（Interventional Cardiology + Vascular Therapies） | 5,089 | 含 AGENT DCB、TCAR、imaging |
| CRM（心率管理） | 2,386 | 稳定基础业务 |
| IO&E（神经介入/栓塞）| 1,157 | Penumbra 收购贡献 |

### 2. MedSurg

| 子业务 | 2026E（USD mn）| 备注 |
|--------|-------------|------|
| Endoscopy | 3,113 | 介入/EUS 全球领导者，1Q26 +6.8% |
| Urology & Pelvic Health | 2,822 | 1Q26 仅 +0.5%（VBP 中国 + supply gaps + 神经调控变更）|
| Neuromodulation | 1,336 | 1Q26 +15.4% |

---

## 核心投资逻辑

### 1. 全球 PFA 技术领导者（FaraPulse）

- FaraPulse 已成为全球 PFA 装机量最高产品
- 1Q26 EP 内生 +21.7%（US +18%）— 高于市场平均
- 但管理层下调 EP 全年指引 → 10%（vs 原 mid-teens），原因：竞争加剧 + PFA 市占率被 J&J Varipulse / Medtronic PulseSelect / Sphere-9 等同业逐步分流
- 长期 PFA 市场（FY28 USD12bn）— 即使份额下滑，绝对收入仍快速增长

### 2. Watchman + CHAMPION-AF 阳性数据（关键利好）

- **CHAMPION-AF**（FY26 主要催化）：N=3,000，平均 CHA₂DS₂-VASc 3.5（中低风险）
...
- 股价 -40% from peak → 17x 2027E P/E（五年低位）
- 管理层明确表态股票被低估 + 启动回购计划

### 4. 新产品周期（2026-27 上市）

- **Farwell Ultra catheter**（神经介入耗材）
- **Seismic coronary IVL**（冠状动脉血管内碎石）
- Penumbra 收购贡献神经介入增量
- CHAMPION-AF 亚组数据 + 指南更新催化 Watchman 渗透率
...
| 其中 EP | 3,750 | 3,881 | -3.4% |
| 其中 LAAC | 2,255 | 2,367 | -4.7% |
...
- **CHAMPION-AF 亚组数据**（2026 后续）— 患者分层细化数据，加速 Watchman 指南更新
- Watchman 临床指南升级（FDA/SCAI）
- Penumbra 业务整合协同效应（2026 完成）
- Farwell Ultra 商业化数据
- Seismic IVL 上市
- 2Q26 业绩验证是否触底（重要观察点）
...
1. **PFA 竞争白热化**：J&J Varipulse + Medtronic PulseSelect/Sphere-9/Sphere-360 + Abbott Volt + Kardium Globe Pulsed Field 等全部进入，份额持续被分流
2. **Watchman 短期增长放缓**：LAAC 全年指引下调至 mid-teens（vs 此前 mid-20%）
