...
STRINGS = {
    ...
    "hc_etf.coverage": "{n} weighted constituents = {cov}% of fund",
    "hc_etf.rest_more": "+{n} more constituents: {syms}",
    "hc_etf.rest_more_trunc": "+{n} more constituents — first {shown}: {syms} …",
    ...
    # ── Strategy Picks tables (audit §7: these were 145 lines of inline
    #    `X if _prefer_cn else Y` dicts in app/pages/4_Strategy_Picks.py) ──
    "picks.tbl.col_rank": "Rank",
    "picks.tbl.col_tick": "Ticker",
    "picks.tbl.col_name": "Name",
    "picks.tbl.col_score": "Score",
    "picks.tbl.col_weight": "Weight",
    "picks.tbl.col_price": "Price",
    "picks.tbl.col_d1": "1D",
    "picks.tbl.col_d5": "5D",
    "picks.tbl.col_m1": "1M",
    "picks.tbl.col_ytd": "YTD",
    "picks.tbl.col_since": "Since",
    "picks.tbl.col_spark": "20D trend",
    "picks.tbl.nm_label": "NM",
    "picks.tbl.brand": "CMSI",
    "picks.tbl.footnote": "Total return incl. dividends (yfinance auto_adjust=True) · Since = pick date to today · YTD = first trading day of current year to today · Trend = last 20 trading-day closes",
    # HD scorecard (governance / financials / moat)
    "picks.sc.hd.col_num": "#",
    "picks.sc.hd.col_held": "Held",
    "picks.sc.hd.col_tick": "Ticker",
    "picks.sc.hd.col_name": "Name",
    "picks.sc.hd.col_ta": "Sector",
    "picks.sc.hd.col_final": "Total",
    "picks.sc.hd.col_seg": "Seg Ret",
    "picks.sc.hd.col_driver": "Grade / status",
    "picks.sc.hd.nm_label": "—",
    "picks.sc.hd.sum_top20": "Top20 EW",
    "picks.sc.hd.sum_pool": "Full pool EW",
    "picks.sc.hd.sum_unheld": "Unheld only",
    "picks.sc.hd.sum_diff": "Top20 − pool",
    "picks.sc.hd.sum_diff_note": "selection effect",
    "picks.sc.hd.sum_n_suffix": "",
    "picks.sc.hd.brand": "CMSI",
    "picks.sc.hd.footnote": "Total = Gov 55 + Fin 25 + Moat 20 · ● = in the top-20 book · scores frozen at inception (v1 2026-03-19 / v2 2026-06-10 scoring worksheets) · segments v1 = 03-20→06-11 / v2 = 06-11→07-07 · segment returns = yfinance total return (reconciled with Wind TR attribution on equal-weight legs) · † = unheld names shown ex-post for reference · selection-effect strip is equal-weight (live v2 book is score-weighted + 12% cash)",
    "picks.sc.hd.sub_gov": "Gov55",
    "picks.sc.hd.sub_fin": "Fin25",
    "picks.sc.hd.sub_moat": "Moat20",
    # Biotech scorecard (L6 attribution appendix)
    "picks.sc.bio.col_num": "#",
    "picks.sc.bio.col_held": "Held",
    "picks.sc.bio.col_tick": "Ticker",
    "picks.sc.bio.col_name": "Company",
    "picks.sc.bio.col_ta": "TA",
    "picks.sc.bio.col_final": "Final",
    "picks.sc.bio.col_seg": "Seg Ret",
    "picks.sc.bio.col_driver": "Price driver / status",
    "picks.sc.bio.nm_label": "—",
    "picks.sc.bio.sum_top20": "Top20 EW",
    "picks.sc.bio.sum_pool": "Full pool EW",
    "picks.sc.bio.sum_unheld": "Unheld only",
    "picks.sc.bio.sum_diff": "Top20 − pool",
    "picks.sc.bio.sum_diff_note": "selection effect",
